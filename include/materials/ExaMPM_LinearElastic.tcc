...
// For GSoC refactor - basic calculation structure should be in place.
// Changes need to be made in final stress computation which will feed back into TimeIntegrator
// Also where properties are stored needs to change 
template <unsigned Tdim>
ExaMPM::LinearElastic<Tdim>::LinearElastic(unsigned id,
...
Eigen::Matrix<double, 6, 1> mpm::LinearElastic<Tdim>::compute_stress(
    ...
    const ParticleBase<Tdim>* ptr, ExaMPM::dense_map* state_vars) {
